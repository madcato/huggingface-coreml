...
class DistilGPT2Tokenizer {
    ...
    static func from_pretrained(_ model_name: String, cache_dir: String? = nil) throws -> DistilGPT2Tokenizer {
        ...
        return try DistilGPT2Tokenizer(urlMerges: urlMerges, urlVocab: urlVocab)
    }
